...
export default function BasicModal({ open, handleClose, handleOpen, id }: ModalProps) {
  ...
  const handleDetail = async () => {
    const getDetail = await listService.getId(id)
    setUpdateDate({
      isLate: getDetail?.isLate,
      date: getDetail?.date,
  ...
  const handleUpdate = async () => {
    const res = await listService.updateDateTime(id, updateDate)
    handleClose()
  }
  return (
    <div>
